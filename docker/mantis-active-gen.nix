...
, midnight-automation, coreutils, gnused, gnugrep, mc, vim, bashInteractive
...
let
  ...
  active-gen = writeShellScriptBin "active-gen" ''
    ${openjdk8_headless}/jre/bin/java -jar ${midnight-automation}/share/java/active-gen-fat.jar "$@"
  '';
in {
